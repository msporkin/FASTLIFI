...
def alignmentTestServo(servoX, servoY, glbl):
    ...
    while duty1 < 8.5 and glbl.link == False:
        duty1 = rightServo(duty1, servoX)
    while duty1 > 2.5 and glbl.link == False:
        duty1 = leftServo(duty1, servoX)
    while duty1 <= 6 and glbl.link == False:
        duty1 = rightServo(duty1, servoX)
    while duty2 < 8.5 and glbl.link == False:
        duty2 = downServo(duty2, servoY)
    while duty2 > 2.5 and glbl.link == False:
        duty2 = upServo(duty2, servoY)
    while duty2 <= 5.5 and glbl.link == False:
        duty2 = downServo(duty2, servoY)
