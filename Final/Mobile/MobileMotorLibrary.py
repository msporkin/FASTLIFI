...
def servoSnake(servoX, servoY, glbl):
    duty1 = 2.5 #set servo motor one to 180 degrees (left side)
    duty2 = 2 #set servo motor two to 180 degrees (left side)
    servoStart(servoX, servoY)
    completedSnake = False
    while glbl.esc == False:
        if glbl.link == False and glbl.snake == True and glbl.targetFound == True and glbl.esc == False and glbl.calibrated == True:
            print('Beginning XY alignment')
            duty1 = 2.5 #set servo motor one to 180 degrees (left side)
            duty2 = 2 #set servo motor two to 180 degrees (left side)
            while duty1 <= 8.5 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 0 to 180 degrees in 100 steps   
                duty1 = rightServo(duty1, servoX)
            time.sleep(2*delayXY)
            while duty2 < 3 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 0 to 180 degrees in 100 steps
                duty2 = downServo(duty2, servoY)
            time.sleep(2*delayXY)
            while duty1 >= 2.5 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 180 to 0 degrees in 100 steps
                duty1 = leftServo(duty1, servoX)
            time.sleep(2*delayXY)
            while duty2 < 4 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 0 to 180 degrees in 100 steps
                duty2 = downServo(duty2, servoY)
            time.sleep(2*delayXY)
            while duty1 <= 8.5 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 0 to 180 degrees in 100 steps
                duty1 = rightServo(duty1, servoX)
            time.sleep(2*delayXY)
            while duty2 < 5 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 0 to 180 degrees in 100 steps
                duty2 = downServo(duty2, servoY)
            time.sleep(2*delayXY)
            while duty1 >=2.5 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 180 to 0 degrees in 100 steps
                duty1 = leftServo(duty1, servoX)
            time.sleep(2*delayXY)
            while duty2 < 6 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 0 to 180 degrees in 100 steps
                duty2 = downServo(duty2, servoY)    
            time.sleep(2*delayXY)
            while duty1 <= 8.5 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 0 to 180 degrees in 100 steps
                duty1 = rightServo(duty1, servoX)
            time.sleep(2*delayXY)
            while duty2 < 7 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 0 to 180 degrees in 100 steps
                duty2 = downServo(duty2, servoY)
            time.sleep(2*delayXY)
            while duty1 >=2.5 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 180 to 0 degrees in 100 steps
                duty1 = leftServo(duty1, servoX)
            time.sleep(2*delayXY)
            while duty2 < 8 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 0 to 180 degrees in 100 steps
                duty2 = downServo(duty2, servoY)
            time.sleep(2*delayXY)
            while duty1 <= 8.5 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 180 to 0 degrees in 100 steps
                duty1 = rightServo(duty1, servoX)
            time.sleep(2*delayXY)
            while duty2 < 8.7 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 0 to 180 degrees in 100 steps
                duty2 = downServo(duty2, servoY)
            time.sleep(2*delayXY)
            while duty1 >=2.5 and glbl.link == False and glbl.targetFound == True and glbl.esc == False and glbl.sweeping == False: #go from 0 to 180 degrees in 100 steps
                duty1 = leftServo(duty1, servoX)
                completedSnake = True
            
            time.sleep(1)
            if glbl.link == False and glbl.sweeping == False and completedSnake == True:
        ...
        while glbl.link == True and glbl.snake == False and glbl.esc == False:    
            if glbl.link == False and glbl.calibrated == False:
                time.sleep(10)
                if glbl.targetFound == True and glbl.calibrated == True:
                    duty1 = 2.5 #set servo motor one to 180 degrees (left side)
                    duty2 = 2 #set servo motor two to 180 degrees (left side)
                    servoStart(servoX, servoY)
                    glbl.setSnake(True)
            elif glbl.link == False and glbl.calibrated == True:
                time.sleep(10)
                if glbl.targetFound == True and glbl.calibrated == False:
                    glbl.setSnake(True)
...
def servoStart(servoX, servoY):
    duty1 = 2.5 #set servo motor one to 180 degrees (left side)
    duty2 = 2 #set servo motor two to 180 degrees (left side)
    #bring PD to origin in bottom right corner
    for i in range(5):
        duty1 = rightServo(2.5, servoX)
    for j in range(5):
