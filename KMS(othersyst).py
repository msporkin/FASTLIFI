...
for r3 in range (0,3):
    ...
    Calibrate2(1,0,0,1)
    time.sleep(delay)
print("U calibration check!")
time.sleep(10)

xCycles = math.atan(.1/9.8)
xCycles = xCycles * 180 / (math.pi * .109)
print(math.floor(xCycles))
for c in range (0, math.floor(xCycles)):
       OneCycleClk1()
       print("stepR")

yCycles = math.atan(.1/9.8)
yCycles = yCycles * 180 / (math.pi * .1047)
print(math.floor(yCycles))
for d in range (0, math.floor(yCycles)):
       OneCycleClk2()
       print("stepT")
