...
def quickAlign(glbl, sequences, ap1, an1, bp1, bn1, ap2, an2, bp2, bn2):
    while abs(glbl.centerFrame[0]-glbl.center[0])>3:
    ...
    while glbl.esc == False: #will run until quit
        if glbl.sweeping == True: #will run only if in sweeping mode
            ...
            if glbl.targetFound == True:
                ...
                quickAlign(glbl, sequences, ap1, an1, bp1, bn1, ap2, an2, bp2, bn2)
